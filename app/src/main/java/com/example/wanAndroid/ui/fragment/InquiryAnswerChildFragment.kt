 ...
 * desc: 子问答Fragment
 */
class InquiryAnswerChildFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun onRefresh() {
        page.onRefresh {
            scope {
                //获取广场列表数据
                data = Get<ApiResponse<ApiPagerResponse<ArrayList<ArticleResponse>>>>("${NetApi.InquiryAnswerAPI}/$index/json").await()
